...
import uk.gov.hmrc.incorporatedentityidentificationfrontend.connectors.IncorporatedEntityIdentificationConnector
import uk.gov.hmrc.incorporatedentityidentificationfrontend.models.CompanyNameStored

import scala.concurrent.Future

@Singleton
class CompanyNameStorageService @Inject()(incorporatedEntityIdentificationConnector: IncorporatedEntityIdentificationConnector) {
