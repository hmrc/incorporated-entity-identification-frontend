...
package test.uk.gov.hmrc.incorporatedentityidentificationfrontend.api.controllers
...
import test.uk.gov.hmrc.incorporatedentityidentificationfrontend.stubs.{AuthStub, IncorporatedEntityIdentificationStub, JourneyStub}
